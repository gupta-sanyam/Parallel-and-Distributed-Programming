...
PROG="a2.py"
ARGS="/panasas/scratch/grp-cse570f21/sanyamgu/T.txt /panasas/scratch/grp-cse570f21/sanyamgu/newSet-planax-3-4"
...
# --driver-memory
# --py-files
SPARK_ARGS="--num-executors 4 --executor-cores 10 --executor-memory 30G"
